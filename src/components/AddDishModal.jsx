        ...
        <div className="d3-card-face rounded-t-3xl max-h-[85vh] overflow-hidden">
          ...
          <div className="px-5 pb-3 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-lg font-bold text-[var(--color-text)]">{dish ? '改改这道菜' : '加一道新菜'}</h2>
            </div>
                ...
                <div key={f.key}>
                  ...
                  <div className="relative">
                    ...
                    <input type={f.type} value={form[f.key]} onChange={e => setForm({ ...form, [f.key]: e.target.value })}
                      className="d3-input w-full pl-9 pr-3 py-2.5 text-sm placeholder:text-[var(--color-text-secondary)]/40 bg-[var(--color-cream-dark)]"
              ...
              <div>
                ...
                <div className="relative">
                  <span className="absolute left-3 top-1/2 -translate-y-1/2 text-sm pointer-events-none opacity-60">
                    ...
                    className="d3-input w-full pl-9 pr-3 py-2.5 text-sm bg-[var(--color-cream-dark)] appearance-none cursor-pointer">
