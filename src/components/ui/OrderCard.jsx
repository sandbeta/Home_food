        ...
        <div className="flex-1" style={{ padding: 'var(--space-card-p)' }}>
          ...
          <div className="flex items-center justify-between gap-2 mb-2">
            <div className="flex items-center gap-2 min-w-0">
              {isAdmin ? (
                <>
                  <span className="text-xs text-[var(--color-ash)] font-mono bg-[var(--surface)] px-2 py-0.5 rounded-full border-2 border-[var(--color-line)] shrink-0">
                    #{order.id}
                  </span>
                  {payerLabel && (
                    <span className="text-xs bg-[var(--surface)] text-[var(--color-ash)] px-2 py-0.5 rounded-full font-semibold border-2 border-[var(--color-line)] shrink-0">
                      {payerLabel}
                    </span>
                  )}
                </>
          ...
          {showNote && order.note && (
            <div className="mt-1.5 px-2 py-1.5 rounded-[var(--radius-tile)] relative overflow-hidden bg-[var(--surface)] border-2 border-[var(--color-line)]">
