...
/**
 * 统一空态 —— 目标是取代散落在 Favorites / MyOrders / AdminDishes / AdminOrders /
 * Cart / Menu 的 6 个手写变体。当前已接入：Cart / Menu / AdminDishes / AdminOrders；
 * Favorites / MyOrders 待 P4 迁移（勿据本注释误判已完成）。
 */
